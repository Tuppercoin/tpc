...
const QString BITCOIN_IPC_PREFIX("Tuppercoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Tuppercoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Tuppercoin: click-to-pay handler");
    else
...
{
    // clicking on Tuppercoin: URLs creates FileOpen events on the Mac:
