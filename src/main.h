...
public:
    ...
    {
        // Tuppercoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Tuppercoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Tuppercoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Tuppercoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Tuppercoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Tuppercoin: block index flags
    enum  
    {
